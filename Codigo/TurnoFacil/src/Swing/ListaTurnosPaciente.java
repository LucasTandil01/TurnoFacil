...
public class ListaTurnosPaciente extends JFrame {
	...
	public void actualizarTurnos() {		
		...
		for(Turno t: p.getTurnosReservados()) {
			info = "MÈdico: " + t.getMedico().getApellido() + ", " + t.getMedico().getNombre() + ". Hora: " +  String.format("%02d",t.getHora())+ ":" + String.format("%02d",t.getMinutos()) +". Fecha: "+t.getFecha().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + ". Duracion: "+t.getDuracion()+"min.";
